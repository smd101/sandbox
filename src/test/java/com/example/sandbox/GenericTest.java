...
public class GenericTest {
  ...
  public void wildcard_test() {
    ...
    // Integer hoge = getList(false).get(0); // ERROR!! Type mismatch: cannot
    // convert from capture#13-of ? to Intege
  ...
  public void wildcard_list_add_test() {
    ...
    // intList.add(new Double(1)); // ERROR!! The method add(Integer) in the type
    // List<Integer> is not applicable for the arguments (Double)
    intList.add(new Integer(1));

    // wildcardList.add(new Double(1)); // ERROR!! The method add(capture#13-of ?)
    // in the type List<capture#13-of ?> is not applicable for the
    // arguments (Double)
    // wildcardList.add(new Integer(1)); // ERROR!! The method add(capture#14-of ?)
    // in the type List<capture#14-of ?> is not applicable for the
    // arguments (Integer)
  }
  ...
  public void wildcard_extends_list_test() {
    ...
    // Number wildcardNum = wildcardList.get(0); // ERROR!! Type mismatch: cannot
    // convert from capture#13-of ? to Number
  ...
  public void wildcard_super_list_test() {
    ...
    // superSample.setHoge(new Double(1)); // The method setHoge(capture#15-of ?
    // super Integer) in the type GenericTest.GenericSample<capture#15-of
